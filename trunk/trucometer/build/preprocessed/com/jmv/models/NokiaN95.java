 ...
 * @author justo.vargas
 */
public class NokiaN95 extends Phone {
    ...
    protected Item[] getGLinesPosition() {
        Item[] result = {new Item(120,57,266),new Item(0,42,240),new Item(0,57,240),new Item(0,76,240), new Item(0,232,240), new Item(0,236,240),new Item(0,275,240),new Item(0,278,240)};
        return result;
    }
    ...
    protected Item[] getGStringsPosition() {
        Item[] result = {new Item(3,42, "Beta version"),new Item(7,57, "USR"), new Item(125,57, "Rival")};;;
        return result;
    }
